 ...
 *
 *  Numbertile-luokka toteuttaa yhden pelin ruudun.
 *
 *  Muokkaukset:
 *  Luotu metodi getNumber. Lisäksi muokattu new_value-metodia siten, että
 *  resetointi on mahdollista eli muu kuin nolla voidaan muuttaa nollaksi.
 *
 *
...
int NumberTile::getNumber() const
{
    return value_;
}
...
{
    //value == 0 is for initializing and new_val == 0 for resetting.
    if( value_ == 0 or new_val == 0)
    {
        value_ = new_val;
        return true;
    }
